...
async function fetchComprobanteEgresoCajaPdf(
  movimientoId: string,
...
export const cajasApi = {
  ...
  obtenerComprobanteEgresoCajaPdf: fetchComprobanteEgresoCajaPdf,

  descargarComprobanteEgresoCaja: async (
    movimientoId: string,
    opts?: { consolidarTodas?: boolean; sucursalId?: string },
  ): Promise<string> => {
    const { blob, filename } = await fetchComprobanteEgresoCajaPdf(movimientoId, opts);
