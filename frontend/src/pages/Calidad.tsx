    ...
    <Layout title="Calidad">
      ...
      {selectedInviteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
          <div className={`w-full max-w-3xl modal-panel rounded-2xl border border-slate-200 border-l-8 ${scoreBorderClass(detailQuery.data?.atencion_general)} bg-gradient-to-b from-white to-slate-50 shadow-2xl`}>
