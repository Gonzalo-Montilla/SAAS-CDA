    ...
    <div className="corporate-shell flex flex-col overflow-x-hidden">
      ...
      >
        <img
          ...
          alt=""
          className="absolute left-0 top-1/2 w-[min(125vw,720px)] sm:w-[min(118vw,880px)] lg:w-[min(102vw,1020px)] max-w-none h-auto -translate-y-1/2 -translate-x-[24%] sm:-translate-x-[28%] lg:-translate-x-[32%] opacity-[0.09] mix-blend-multiply select-none"
        />
      </div>
